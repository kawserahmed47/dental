    ...
    <section class="inner-banner">
        <div class="container">
            ...
            <li class="thm-breadcrumb__item"><a class="thm-breadcrumb__link" href="{{route('index')}}">Home</a></li>
                ...
                <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="{{route('doctorSchedules')}}">Doctors' Schedules</a></li>
            </ul><!-- /.thm-breadcrumb -->
        </div><!-- /.container -->
                    ...
                    <div class="service-sidebar">
                        <div class="service-sidebar__single">
                            <ul class="service-sidebar__list">
                                ...
                                <a href="{{route('doctorSchedules')}}" class="service-sidebar__list-link">Docotrs' Schedules</a>
                ...
                <div class="col-lg-9">
                    <div class="patient-content">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>{{++$key}}</td>
                                <td> Dr. {{$appointment->fname}}  {{$appointment->lname}}</td>
