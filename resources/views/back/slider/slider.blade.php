                ...
                <div class="page-title" style="padding: 0px 25px;">
                    ...
                    <div class="pull-right mt-2 pt-2">
                        ...
                        <a href="#" type="button" class="btn btn-primary" data-toggle="modal"
                           data-target="#exampleModal" id="addslider">Add Slider</a>
                        <!-- PAGE HEADING TAG - END -->
                    </div>
                            ...
                            <div class="row">
                                ...
                                <table id="example" class="display table table-hover table-condensed table table-striped">
                                    ...
                                    @foreach($data as $key=>$value)
                                        <tr>
                                            <td width="5%">{{$key+1}}</td>
                                            <td width="20%"> {!! html_entity_decode($value->title) !!}</td>
                                            <td width="20%"> {!! html_entity_decode($value->subtitle) !!}</td>
                                            <td width="5%">{{$value->status}}</td>
                                            <td width="20%"><img
                                                    src="{{asset('public/storage/slider/'.$value->image) }}"
                                            ...
                                            <td width="30%">
                                                ...
                                                <button class="btn" type="button" onclick="deleteSlider({{ $value->id }})">
                                                     <i class="material-icons btn delete-confirm" style="font-size:30px;color:red;">delete</i>
                                                </button>


                                                <form id="delete-form-{{ $value->id }}" action="{{ route('slider.destroy',$value->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('slider.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="form-label" for="field-1">Sub Title</label>
                            <span class="desc"></span>
                            <div class="controls">
                                {{--                                <input type="text" name="subtitle" class="form-control" id="field-1">--}}
                                <textarea id="editor" name="subtitle" class="form-control" cols="30" rows="2"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-label" for="field-1">Slider Image</label>
                            <span class="desc"></span>
                            <div class="controls">
