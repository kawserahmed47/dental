    ...
    <div class='quick-area'>
        <div class='pull-left'>
            <ul class="info-menu left-links list-inline list-unstyled">
                ...
                <a href="{{route('appointmentList')}}" class="new-link w-text">Schedule
        ...
        <div class='pull-right'>
            <ul class="info-menu right-links list-inline list-unstyled">
                ...
                <li class="profile">
                    <a href="#" data-toggle="dropdown" class="toggle">
                        <img src="{{asset('public/storage/doctorinfo/-2020-09-01-5f4e74cccbe6f.png')}}" alt="user-image" class="img-circle img-inline">
                        <span>Dr.Akhi-Nur-Mallik (Falguni)<i class="fa fa-angle-down"></i></span>
                    </a>
