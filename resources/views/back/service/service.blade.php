            ...
            <div class='col-xs-12'>
                <div class="page-title" style="padding: 0px 25px;">
                    <div class="pull-left">
                        ...
                        <h1 class="title">Services Information</h1>
                    ...
                    <div class="pull-right mt-2 pt-2">
                        ...
                        <a href="#" type="button" class="btn btn-primary" data-toggle="modal"
                           data-target="#exampleModal" id="addslider">Add Service Info</a>
                        <!-- PAGE HEADING TAG - END -->
                    </div>
                                ...
                                <table id="example" class="display table table-hover table-condensed table table-striped">
                                    ...
                                    @foreach($data as $key=>$value)
                                        <tr>
                                            ...
                                            <td width="20%"><img
                                                    src="{{asset('public/storage/service/'.$value->image)}}"
...
{{--                                                                                                                                            <a href="{{ route('admin.post.edit',$post->id) }}" class="btn btn-info waves-effect">--}}
                                                ...
                                                <a class="btn delete-confirm"  href="{{url('service/'.$value->id)}}">
                                                    <i class="material-icons delete-confirm" style="font-size:30px;color:red;">delete</i>
                                                </a>
{{--                                                                                                                                            <button class="btn btn-danger waves-effect" type="button" onclick="deletePost({{ $post->id }})">--}}
{{--                                                <button class="btn" type="button" onclick="deleteServiceInfo({{ $value->id }})">--}}
{{--                                                    <i class="material-icons btn delete-confirm" style="font-size:30px;color:red;">delete</i>--}}
{{--                                                </button>--}}


{{--                                                <form id="delete-form-{{ $value->id }}" action="{{ url('service',$value->id) }}" method="POST" style="display: none;">--}}
{{--                                                    @csrf--}}
{{--                                                    @method('DELETE')--}}
{{--                                                </form>--}}
